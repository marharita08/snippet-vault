...
export const SnippetCard: React.FC<SnippetCardProps> = ({
  ...
  return (
    <article
      ...
      className={cn(
        "group relative rounded-xl border border-muted/60 bg-white p-5 shadow-sm transition-all duration-200 hover:shadow-md hover:border-primary/30 hover:-translate-y-0.5",
        className,
      )}
    >
